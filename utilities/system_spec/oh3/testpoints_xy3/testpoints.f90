...
program testpoints
  ...
  do i=1,npts
    ...
    call EvaluateSurfgen_XY3(cgeoms(1,i),e,cg,h,dcg)
    print *,""
...
contains
  ...
  subroutine calcHess(natoms,cgeom,nstate,istate,stepsize,hessian,centerd,skip)
    ...
    if(.not.centerd)then
            call EvaluateSurfgen_XY3(cgeom,e,cg,h,dcg)
    ...
    do i=1,3*natoms
            ...
            call EvaluateSurfgen_XY3(dispgeom,e,cg,h,dcg)
  ...
  subroutine generate_grid_gh(geom, gv, hv, ndisps, na, dsize)
    ...
    do i = 0 - ndisps, ndisps
            do j = 0 - ndisps, ndisps
                    ...
                    gdisp = gdisp + dsz * i * x
                    gdisp = gdisp + dsz * j * y
                    call EvaluateSurfgen_XY3(gdisp,e,cg,h,dcg)
